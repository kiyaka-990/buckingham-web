...
export const metadata: Metadata = {
  title: "Our Breeds",
  description: "Explore the seven guardian and working breeds raised at Buckingham Kennel, from the Boerboel to the Kangal.",
};
  ...
  return (
    <>
      <PageHero
        ...
        title="Our Breeds"
        subtitle="Seven distinguished breeds, each raised to the Buckingham standard of health, temperament and type."
