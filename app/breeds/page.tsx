                    ...
                    <Reveal key={b.slug} delay={i % 3}>
                      <Link href={`/breeds/${b.slug}`} className="group block overflow-hidden rounded-3xl border border-border bg-surface card-hover">
                        <div className="relative aspect-[16/10] overflow-hidden">
                          ...
                          {count > 0 && <span className="absolute right-3 top-3 rounded-full bg-brass-400 px-3 py-1 text-xs font-semibold text-forest-900">{count} available</span>}
                        </div>
                        <div className="p-5">
                          <h3 className="font-display text-xl font-bold group-hover:text-brass-500">{b.name}</h3>
                          ...
                          <span className="mt-4 inline-flex items-center gap-1 text-sm font-medium text-brass-500">
