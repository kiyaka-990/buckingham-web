          ...
          {services.map((s, i) => (
            <Reveal key={s.slug} delay={i % 3}>
              <div className="group h-full rounded-3xl border border-border bg-surface p-7 card-hover">
                <div className="mb-5 grid h-14 w-14 place-items-center rounded-2xl bg-gold-400/12 text-gold-500 transition group-hover:bg-gold-400 group-hover:text-navy-900">
                  <s.icon size={26} />
                </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <div className="relative overflow-hidden rounded-[2rem] bg-navy-900 p-10 text-center text-white sm:p-16">
          ...
          <div className="relative mx-auto max-w-2xl">
            ...
            <p className="mx-auto mt-4 max-w-xl text-navy-50/80">Talk to our team about a package combining the perfect dog, training and delivery for your needs.</p>
