...
export function BreedVideo({
  ...
  return (
    <figure className="overflow-hidden rounded-3xl border border-border bg-surface">
      <div className="group relative aspect-video bg-clay-950">
        <video
          ref={ref}
          src={src}
          poster={poster}
        ...
        {!playing && (
          <button
            ...
            className="absolute inset-0 grid place-items-center bg-clay-950/35 transition group-hover:bg-clay-950/45"
          >
            <span className="grid h-16 w-16 place-items-center rounded-full btn-clay shadow-lift transition group-hover:scale-105">
